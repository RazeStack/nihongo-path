...
export const N4_FINAL_EXAM_LESSONS: LessonDefinition[] = [
  {
    ...
    theory: [
      ...
      {
        type: 'paragraph',
        text: 'Смешанная проверка по всему N4: たら/なら/ながら/そう, потенциальная/пассивная/побудительная формы, てあげる/てもらう/てくれる, предположения (でしょう/かもしれない/はず/つもり), причины и уступки (ので/のに/し), 305 слов словаря по 16 темам, 72 новых кандзи и понимание пяти более длинных текстов.',
      },
      {
        type: 'note',
