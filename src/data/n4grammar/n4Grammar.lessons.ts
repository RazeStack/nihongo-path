...
const introLesson: LessonDefinition = {
  ...
  blockId: BLOCK_ID,
  title: 'Напоминание: て/た-форма',
  description: 'Как образуется — она нужна для たら, изученной в этом блоке',
  order: 0,
  theory: [
    { type: 'heading', text: 'Быстрое напоминание' },
    {
      type: 'paragraph',
      text: 'て-форма и た-форма (простое прошедшее время) образуются по одним и тем же правилам — в N5 они уже разобраны подробно вместе с ています, てください, てもいいです и てはいけません. Здесь — только напоминание таблицы образования, потому что на её основе строится たら, которая изучается в этом блоке.',
    },
    {
      type: 'table',
