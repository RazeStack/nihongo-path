...
export const N4_GRAMMAR_BLOCK: BlockDefinition = {
  ...
  description: 'たら и なら — условие «если/когда»; ながら — два действия одновременно; そうです — пересказ услышанного. Опираются на て/た-форму, изученную в N5.',
  order: 1,
  contentType: 'grammar',
  ...
  exam: {
    ...
    description: 'Проверка たら, なら, ながら и そうです.',
    questionCount: 10,
    passingScore: 0.8,
    xpReward: 220,
  },
