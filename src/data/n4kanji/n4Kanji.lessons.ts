...
const introLesson: LessonDefinition = {
  ...
  theory: [
    ...
    {
      type: 'paragraph',
      text: 'Почти все 24 кандзи этого блока уже встречались в блоке "Словарь N4" как целые слова (например 会社, 天気, 必要). Здесь они разбираются как отдельные знаки — с чтениями и связанными словами — чтобы ты видел, из каких "кирпичиков" состоят уже знакомые слова, и мог узнавать их в НОВЫХ комбинациях.',
    },
    {
      type: 'note',
