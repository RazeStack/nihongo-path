...
export const N4_VOCABULARY_BLOCK: BlockDefinition = {
  ...
  levelId: 'n4',
  title: 'Словарь N4',
  description: '305 слов по 16 темам: работа, учёба, природа и погода, эмоции, абстрактные понятия, общество, технологии, отношения, путешествия, здоровье, характер, еда, глаголы, прилагательные, наречия и повседневные ситуации.',
  order: 5,
