...
const introLesson: LessonDefinition = {
  ...
  description: 'Ещё 20 иероглифов из уже знакомых слов Словаря N2',
  order: 0,
  theory: [
    { type: 'heading', text: 'Последний блок кандзи курса' },
    {
      type: 'paragraph',
      text: 'Как и на N4-N3, эти 20 кандзи разбирают по кирпичикам слова, уже введённые в блоке Словарь N2 — деловые, научные и медийные термины.',
    },
  ],
  miniCheck: [],
  itemIds: [],
